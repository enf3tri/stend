...
import './iPhoneXRXSMax1126.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class iPhoneXRXSMax1124 extends StatelessWidget {
  iPhoneXRXSMax1124({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 263.0, middle: 0.4834),
            Pin(size: 69.0, end: 106.0),
            child: Container(
              decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 174.0, end: 40.0),
            Pin(size: 106.0, middle: 0.6127),
            child: Text(
              'Welcome\nBack',
              style: TextStyle(
                fontFamily: 'Poppins',
