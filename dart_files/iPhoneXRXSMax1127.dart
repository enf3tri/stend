...
class iPhoneXRXSMax1127 extends StatelessWidget {
  iPhoneXRXSMax1127({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  Pin(size: 109.0, start: 16.0),
                  Pin(size: 23.0, middle: 0.7657),
                  child: Text(
                    '**************',
                    style: TextStyle(
                      fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(size: 113.0, end: 59.0),
            Pin(size: 165.0, middle: 0.5705),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 61.0, middle: 0.4901),
            Pin(size: 25.0, end: 91.0),
            child: Text(
              'Sign In',
              style: TextStyle(
                fontFamily: 'Poppins',
