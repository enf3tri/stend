...
class iPhoneXRXSMax116 extends StatelessWidget {
  iPhoneXRXSMax116({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 201.1, middle: 0.5),
            Pin(size: 197.0, middle: 0.6309),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: -560.5, end: -62.5),
                  Pin(start: -46.1, end: -64.2),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                        Pin(start: 0.0, end: 0.0),
          ...
          Pinned.fromPins(
            Pin(size: 88.0, middle: 0.6365),
            Pin(size: 1.0, middle: 0.605),
            child: SvgPicture.string(
              _svg_mg3pdd,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(size: 88.0, middle: 0.365),
            Pin(size: 1.0, middle: 0.6045),
            child: SvgPicture.string(
              _svg_cb6r6h,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(size: 56.0, middle: 0.4218),
            Pin(size: 62.0, middle: 0.6487),
            child: SvgPicture.string(
              _svg_fe2h74,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(size: 56.0, middle: 0.5782),
            Pin(size: 62.0, middle: 0.5743),
            child: SvgPicture.string(
              _svg_3vzk7c,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
...
const String _svg_kxzo7l =
    '<svg viewBox="207.5 0.5 1.0 541.0" ><path transform="translate(207.5, 0.5)" d="M 0 0 L 0 541" fill="none" stroke="#ffffff" stroke-width="5" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_qmp78c =
    '<svg viewBox="-460.8 199.9 824.1 307.3" ><path transform="translate(-1028.0, -262.0)" d="M 1391.350708007812 533.2703247070312 L 1391.350708007812 769.2020263671875 L 567.2056884765625 769.2020263671875 L 567.2056884765625 533.2703247070312 C 567.2056884765625 533.2703247070312 608.8154907226562 477.1579895019531 662.9505004882812 468.2701416015625 C 717.0855102539062 459.3822937011719 729.865234375 502.4765319824219 778.5545043945312 497.7189636230469 C 827.2437744140625 492.9613952636719 837.3819580078125 459.2269287109375 885.4570922851562 462.0548706054688 C 933.5322265625 464.8828125 938.8229370117188 489.4818115234375 978.0650024414062 484.7242431640625 C 1017.306945800781 479.9666748046875 1040.721923828125 465.4421997070312 1088.074951171875 468.2701416015625 C 1135.427978515625 471.0980834960938 1132.212280273438 519.910400390625 1178.042602539062 509.03076171875 C 1223.872924804688 498.1511535644531 1216.6376953125 482.2855224609375 1253.401000976562 479.4575805664062 C 1290.164306640625 476.629638671875 1297.847534179688 491.2268981933594 1332.95654296875 509.03076171875 C 1368.065551757812 526.8346557617188 1391.350708007812 533.2703247070312 1391.350708007812 533.2703247070312 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_i9m7vv =
    '<svg viewBox="207.5 456.5 1.0 85.0" ><path transform="translate(207.5, 456.5)" d="M 0 0 L 0 85" fill="none" stroke="#ffffff" stroke-width="6" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_mg3pdd =
    '<svg viewBox="207.5 541.5 88.0 1.0" ><path transform="translate(207.5, 541.5)" d="M 88 0 L 0 0" fill="none" stroke="#ffffff" stroke-width="6" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_cb6r6h =
    '<svg viewBox="119.0 541.0 88.0 1.0" ><path transform="translate(119.0, 541.0)" d="M 88 0 L 0 0" fill="none" stroke="#ffffff" stroke-width="6" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_agjvbf =
    '<svg viewBox="207.0 541.5 1.0 85.0" ><path transform="translate(207.0, 541.5)" d="M 0 0 L 0 85" fill="none" stroke="#ffffff" stroke-width="6" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_fe2h74 =
    '<svg viewBox="151.0 541.0 56.0 62.0" ><path transform="translate(151.0, 541.0)" d="M 56 0 L 0 62" fill="none" stroke="#ffffff" stroke-width="6" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_3vzk7c =
    '<svg viewBox="207.0 479.0 56.0 62.0" ><path transform="translate(207.0, 479.0)" d="M 56 0 L 0 62" fill="none" stroke="#ffffff" stroke-width="6" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_c4rnq8 =
    '<svg viewBox="151.0 479.0 56.0 62.0" ><path transform="translate(151.0, 479.0)" d="M 0 0 L 56 62" fill="none" stroke="#ffffff" stroke-width="6" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
...
const String _svg_nq9jko =
    '<svg viewBox="207.0 541.0 56.0 62.0" ><path transform="translate(207.0, 541.0)" d="M 0 0 L 56 62" fill="none" stroke="#ffffff" stroke-width="6" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
