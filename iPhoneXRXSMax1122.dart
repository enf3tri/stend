...
import './iPhoneXRXSMax1123.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class iPhoneXRXSMax1122 extends StatelessWidget {
  iPhoneXRXSMax1122({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 24.0, end: 24.0),
            Pin(size: 56.0, middle: 0.6929),
            child: PageLink(
              links: [
                PageLinkInfo(
                  ease: Curves.slowMiddle,
                  duration: 0.6,
                  pageBuilder: () => iPhoneXRXSMax1123(),
                ),
              ],
              child: Container(
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(24.0),
                  color: const Color(0xffa3ffb9),
                ),
              ),
            ),
          ),
...
const String _svg_a441zc =
    '<svg viewBox="24.0 151.0 366.0 415.0" ><defs><pattern id="image" patternUnits="userSpaceOnUse" width="348.0" height="472.0"><image xlink:href="null" x="0" y="0" width="348.0" height="472.0" /></pattern></defs><path transform="translate(24.0, 151.0)" d="M 0 0 L 366 0 L 366 415 L 0 415 L 0 0 Z" fill="url(#image)" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
