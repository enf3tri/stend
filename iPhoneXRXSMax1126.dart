...
class iPhoneXRXSMax1126 extends StatelessWidget {
  iPhoneXRXSMax1126({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 174.0, end: 36.0),
            Pin(size: 106.0, end: -149.0),
            child: Text(
              'Welcome\nBack',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(size: 161.0, start: 22.0),
            Pin(size: 170.0, end: -170.0),
            child:
                // Adobe XD layer: 'business-3d-waving-…' (shape)
                Container(
              decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            ...
            Pin(size: 385.7, end: -438.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                  Pin(size: 52.0, middle: 0.5415),
                  child: Container(
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(10.0),
                      border: Border.all(
                ...
                Pinned.fromPins(
                  Pin(size: 136.0, start: 7.0),
                  Pin(size: 56.0, middle: 0.2539),
                  child: Text(
                    'Sign In',
                    style: TextStyle(
                      fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            ...
            Pin(size: 165.0, end: -170.0),
            child:
                // Adobe XD layer: 'business-3d-with-co…' (shape)
                Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage(''),
