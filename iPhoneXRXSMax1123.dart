...
class iPhoneXRXSMax1123 extends StatelessWidget {
  iPhoneXRXSMax1123({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: RadialGradient(
                  ...
                  radius: 0.5,
                  colors: [const Color(0x69c9c9c9), const Color(0x69656565)],
                  stops: [0.0, 1.0],
          ...
          Pinned.fromPins(
            ...
            Pin(size: 296.0, middle: 0.51),
            child:
                // Adobe XD layer: 'business-3d-thumb-u…' (shape)
                Container(
              decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(start: 66.0, end: 65.0),
            Pin(size: 173.0, middle: 0.2254),
            child: Text(
              'Your question shared!',
              style: TextStyle(
                fontFamily: 'Poppins',
                fontSize: 39,
          ...
          Pinned.fromPins(
            Pin(size: 61.2, start: 54.2),
            Pin(size: 84.4, middle: 0.8329),
          ...
          Pinned.fromPins(
            Pin(size: 33.5, middle: 0.3369),
            Pin(size: 79.6, middle: 0.8349),
            child: SvgPicture.string(
              _svg_fo4jth,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(size: 60.2, middle: 0.4803),
            Pin(size: 59.8, middle: 0.8378),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
          ...
          Pinned.fromPins(
            Pin(size: 53.1, middle: 0.6518),
            Pin(size: 60.6, middle: 0.8375),
            child: SvgPicture.string(
              _svg_nvnil4,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(size: 61.3, end: 54.2),
            Pin(size: 87.6, middle: 0.8325),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
